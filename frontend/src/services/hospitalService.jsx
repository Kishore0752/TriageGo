 ...
 * @param {string} mode - 'symptoms' or 'hospitals'
 */
...
/**
 * Fetch heatmap data for hospital density
 */
...
/**
 * Fetch contact details for a hospital
 */
export const fetchContactDetails = async (placeId) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/contact-details`, { place_id: placeId });
    return response.data;
  } catch (error) {
    console.error('Contact Details API Error:', error.message);
